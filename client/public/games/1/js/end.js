...
Game.End.prototype = {
	...
	tweet: function() {
		window.open('http://twitter.com/share?text=I+just+saved+'+score+'+rabbits+at+"I+Hate+Rabbits"+game!+Try+to+beat+me+here&via=VuSnail&url=http://snailcom.com/games/1', '_blank');
	}
};
